    ...
    <main className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#f7f9fb] px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
      ...
      <section className="relative z-10 flex w-full max-w-[27.5rem] flex-col gap-6 sm:gap-7">
        <header className="flex flex-col items-center gap-2 text-center">
          ...
          <h1 className="text-[1.65rem] font-semibold tracking-[-0.01em] text-[#191c1e] sm:text-[1.85rem]">UltimateConsult</h1>
          <p className="max-w-xs text-base text-[#45464d] sm:max-w-none">Secure access to ConsultantAdmin portal</p>
        </header>

        <div className="rounded-xl border border-[#c6c6cd] bg-white p-5 shadow-[0_4px_20px_rgba(15,23,42,0.05)] sm:p-8">
          <form className="flex flex-col gap-6" noValidate>
            <div className="space-y-2">
              <label className="text-sm font-medium text-[#45464d]" htmlFor="email">
                Email Address
              </label>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between gap-2">
                <label className="text-sm font-medium text-[#45464d]" htmlFor="password">
                  Password
                </label>
                <a className="text-xs font-semibold uppercase tracking-[0.06em] text-[#006c49] transition hover:underline" href="#">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
            ...
            <label className="flex items-center gap-2 text-sm text-[#45464d]">
              <input type="checkbox" className="h-4 w-4 rounded border-[#c6c6cd] text-[#006c49] focus:ring-[#6cf8bb]/40" />
        ...
        <footer className="space-y-2 text-center">
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs font-semibold tracking-[0.05em] text-[#45464d] sm:text-sm">
            <a href="#" className="transition hover:text-[#006c49]">
              Privacy Policy
            </a>
            <span className="hidden h-1 w-1 rounded-full bg-[#c6c6cd] sm:inline-block" />
            <a href="#" className="transition hover:text-[#006c49]">
              Terms of Service
            </a>
            <span className="hidden h-1 w-1 rounded-full bg-[#c6c6cd] sm:inline-block" />
          ...
          <p className="text-xs text-[#76777d]/75 sm:text-sm">© 2024 UltimateConsult. All rights reserved.</p>
        </footer>
      </section>
    </main>
  );
